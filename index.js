...
module.exports = {
  ...
  plugins: ['html'], // 第三方插件，需要npm安装支持，形式为eslint-plugin-xxx
  ...
  rules: { // 具体规则
    ...
    'camelcase': [2, { 'properties': 'never' }], // 强制使用骆驼拼写法命名约定，属性名可以不是
    'comma-dangle': [2, 'only-multiline'], // 要求或禁止末尾逗号
    ...
    'no-func-assign': 2, // 止对 function 声明重新赋值
